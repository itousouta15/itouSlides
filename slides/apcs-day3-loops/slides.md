...
<!--
回收暖身問題的 1 加到 100，這次用迴圈解出 5050。

紅框要用力講：**累加變數一定要放在迴圈外面**。下一張會示範放錯的後果。
-->
...
那個比喻很好用：「每輪開始都重新拿一張全新的紙，之前寫的全部作廢」。
...
「是誰讓條件終究會不成立？」——要求他們每次寫 while 前先在心裡問一次。

黃框：答不出來，代表還沒想清楚這個迴圈什麼時候該停。Q3 會考這句。
-->
