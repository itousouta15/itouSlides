...
| 時段          | 內容                     |
| ------------- | ------------------------ |
| 00:00 – 00:20 | 開場、暖身、環境檢查     |
| 00:20 – 01:00 | 電腦怎麼看懂你的程式     |
| 01:00 – 01:50 | 第一支程式：Hello World  |
| 01:50 – 02:05 | ☕ 中場休息              |
| 02:05 – 02:45 | cin 讀取輸入             |
| 02:45 – 03:05 | 程式骨架、判題結果、小考 |
| 03:05 – 03:15 | 🍱 短暫休息              |
| 03:15 – 03:55 | 今日題目實作             |
| 03:55 – 04:00 | 回顧、預告明天           |
...
> 中間會停下來好幾次，不是進度落後，是刻意的——寫程式這件事，停下來想清楚比一直往前衝更重要。
...
- 你每天用的 App、遊戲、網站，背後都是程式碼
- 學程式不是要背語法，是學一種**拆解問題**的方式
- 這個能力離開電腦教室之後，一樣有用
- 今天的目標很小：**讓電腦照你的話做事**
...
寫程式最有趣的地方：你不需要說服任何人，**電腦立刻告訴你對不對**。
...
如果你的程式顯示 **WA**，你會先檢查哪三件事？跟旁邊同學討論一分鐘。

<div class="mt-6 text-sm opacity-70">

提示：想想今天講過的「常見錯誤」那幾張投影片。
...
跟旁邊同學**互相檢查**彼此程式的輸出格式，有沒有多印或少印空白、標點符號對不對。

<div class="mt-6 border-l-4 border-blue-500 pl-4 text-sm">

自己盯著自己的程式碼，最容易忽略掉的往往就是格式細節——別人的眼睛通常抓得比較快。
